...
if (!validateConfigs_1.validateConfigs([config])) {
    process.exit(1);
}
main_1.generate(config)
    .catch((e) => {
...
function printHelp({ useYarn, dirPath, dependencies }) {
    ...
    console.log();
    console.log('PS: `@genql/runtime` should always have the same version as the cli!');
    console.log();
}
...
function readFile(p) {
    ...
    return fs_1.readFileSync(p).toString();
}
